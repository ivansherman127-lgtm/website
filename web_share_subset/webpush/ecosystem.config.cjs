  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        ...
        YANDEX_CLIENT_ID: serverSecrets.YANDEX_CLIENT_ID || process.env.YANDEX_CLIENT_ID || "",
        YANDEX_CLIENT_SECRET: serverSecrets.YANDEX_CLIENT_SECRET || process.env.YANDEX_CLIENT_SECRET || "",
        ANALYTICS_REBUILD_URL: "http://127.0.0.1:3000/api/analytics/rebuild",
        ANALYTICS_REBUILD_SECRET: serverSecrets.ANALYTICS_REBUILD_SECRET || process.env.ANALYTICS_REBUILD_SECRET || "",
      },
    },
  ],
